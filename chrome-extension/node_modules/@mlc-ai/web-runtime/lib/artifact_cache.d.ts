 ...
 */
export declare function hasTensorInCache(tensorCacheUrl: string, cacheScope?: string, cacheType?: string): Promise<boolean>;
/**
 ...
 * @param cacheType The type of the cache: "cache" or "indexedDB"
 */
export declare function deleteTensorCache(cacheUrl: string, cacheScope?: string, cacheType?: string): Promise<void>;
