 ...
 */
declare class PackedFuncCell extends TVMObject {
    constructor(handle: Pointer, lib: FFILibrary, ctx: RuntimeContext);
}
/**
 * Tensor( n-dimnesional array).
 */
export declare class Tensor extends TVMObject {
     ...
     * @returns this
     */
    copyFrom(data: Tensor | Array<number> | Float32Array | Float64Array | Int32Array | Int8Array | Uint8Array | Uint8ClampedArray): this;
    /**
 ...
 * Runtime Module.
 */
export declare class Module extends TVMObject {
    constructor(handle: Pointer, lib: FFILibrary, ctx: RuntimeContext);
    /**
...
export declare class Instance implements Disposable {
    ...
    *
     ...
     */
    tensorCacheUpdate(name: string, arr: Tensor, override?: boolean): void;
    /**
     * Update the tensor cache.
     * @param name The name of the array.
     * @param arr The content.
     */
    tensorCacheClear(): void;
    /**
     ...
     */
    fetchTensorCache(tensorCacheUrl: string, device: DLDevice, cacheScope?: string, cacheType?: string, signal?: AbortSignal): Promise<any>;
    /**
     ...
     * @param signal An optional AbortSignal to abort the fetch
     */
    private fetchTensorCacheInternal;
    /**
     ...
     */
    empty(shape: Array<number> | number, dtype?: string | DLDataType, dev?: DLDevice): Tensor;
    /**
     ...
     * @returns The created ndarray.
     */
    uniform(shape: Array<number>, low: number, high: number, dev: DLDevice): Tensor;
    /**
     ...
     */
    applyRepetitionPenalty(logits: Tensor, token_ids: Tensor, penalty: number): any;
    /**
     ...
     */
    applyPresenceAndFrequencyPenalty(logits: Tensor, token_ids: Tensor, token_freqs: Tensor, presence_penalty: number, frequency_penalty: number): any;
    /**
     ...
     */
    applySoftmaxWithTemperature(logits: Tensor, temperature: number): any;
    /**
     ...
     */
    showImage(dataRGBA: Tensor): void;
    /**
     * Clear canvas
     */
    clearCanvas(): void;
     ...
     * @returns The result array.
     */
    makeTVMArray(inputs: Array<any>): TVMArray;
    /**
     ...
     */
    setPackedArguments(stack: CachedCallStack, args: Array<any>, packedArgs: PtrOffset): void;
    private wrapJSFuncAsSafeCallType;
