...
export declare class RPCServer {
    ...
    private tensorCacheUrl;
    private tensorCacheDevice;
    ...
    constructor(url: string, key: string, getImports: () => Record<string, unknown>, logger?: (msg: string) => void, tensorCacheUrl?: string, tensorCacheDevice?: string, initProgressCallback?: runtime.InitProgressCallback | undefined, asyncOnServerLoad?: ((inst: runtime.Instance) => Promise<void>) | undefined);
    private onClose;
    private onOpen;
