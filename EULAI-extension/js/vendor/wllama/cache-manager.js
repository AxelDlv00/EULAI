...
class CacheManager {
   ...
   */
  static async getNameFromURL(url) {
   ...
   */
  static async write(name, stream, metadata) {
    this.writeMetadata(name, metadata); // 'this' refers to the Class here, which works for static methods
   ...
   */
  static async deleteMany(predicate) {
    const cacheDir = await getCacheDir();
   ...
   */
  static async writeMetadata(name, metadata) {
